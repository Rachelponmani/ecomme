<%@ page language="java" import="com.model.Cart" contentType="text/html; charset=ISO-8859-1"
						...
						<tr>
						   	<td data-th="Product">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										<h4 class="nomargin">${cartitem.prodname}</h4>
							...
							<td data-th="Subtotal" class="text-center" id="amount"><span id="subtotal" class="subtotal">RS</span></td>
